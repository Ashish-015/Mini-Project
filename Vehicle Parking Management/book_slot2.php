    ...
    <div class="container">
        ...
        <div class="row">
            ...
            ?>
                    <div class="col-lg-2">
                        <hr>
                        <a type=" button" class="btn btn-success btn-lg btn-block" href="source/confirm_slot.php?slot_id=<?php echo $data['slot_id']; ?>&&user_id=<?php echo $user_id; ?>">Slot
            ...
            <p style="padding:50px">
                <small>
                    ...
                    <img src=" images/icon/green_block.png" height="20px" width="20px" style="border:1px solid;">
                    slot available
                </small>
            </p>
        </div>
